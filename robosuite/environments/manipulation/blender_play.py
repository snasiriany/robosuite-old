...
from robosuite.models.objects import BlenderObject
...
class BlenderPlay(SingleArmEnv):
    def __init__(
        self,
        robots,
    ...
    def _load_model(self):
        ...
        if self.placement_initializer is not None:
            ...
            self.placement_initializer.add_objects(self.blender_obj)
        else:
            self.placement_initializer = UniformRandomSampler(
                name="ObjectSampler",
                mujoco_objects=self.blender_obj,
                x_range=[-0.03, 0.03],
                y_range=[-0.03, 0.03],
                rotation=None,
